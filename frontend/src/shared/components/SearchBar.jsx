...
const SearchBar = ({ className = '', size = 'default' }) => {
  ...
  return (
    <div className={`w-full relative ${className}`} ref={searchRef}>
      ...
      {showSuggestions && hasSuggestions && (
        <div
          ref={suggestionsRef}
          className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-2xl border border-gray-200 z-[10005] max-h-96 overflow-y-auto"
        >
          {/* Product Suggestions */}
