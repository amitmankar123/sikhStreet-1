...
const Categories = () => {
  ...
  return (
    <motion.div
      ...
      {/* Header */}
      <div className="sticky top-0 z-30 bg-gray-50/95 backdrop-blur-md pb-4 pt-1 sm:pt-2 -mx-3 px-3 sm:-mx-4 sm:px-4 lg:-mx-6 lg:px-6 border-b border-gray-200/50 shadow-sm space-y-3 sm:space-y-0 mb-6">
      ...
      {/* Filters */}
      <div className="bg-white rounded-xl p-3 sm:p-4 shadow-sm border border-gray-200 mx-3 sm:mx-0">
