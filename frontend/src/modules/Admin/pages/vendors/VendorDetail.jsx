        ...
        <div className="flex items-center gap-2">
          ...
          {(vendor.status === "pending" || vendor.status === "suspended" || vendor.status === "rejected") && (
            <button
              ...
              <FiCheckCircle />
              {vendor.status === "suspended" ? "Reactivate" : "Approve"}
            </button>
          )}
          {vendor.status === "approved" && (
            <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                      <FiShoppingBag className="text-gray-400 mt-1" />
                      <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-3">
                          <div>
                            ...
                            <p className="font-semibold text-gray-800">{vendor.businessName || "N/A"}</p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-500">Business Type</p>
                            <p className="font-semibold text-gray-800">{vendor.businessType || "N/A"}</p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-500">Country</p>
                            <p className="font-semibold text-gray-800">{vendor.businessCountry || "N/A"}</p>
                          </div>
                        </div>
                        <div className="space-y-3">
                          <div>
                            <p className="text-xs text-gray-500">Business Address</p>
                            <p className="font-semibold text-gray-800">{vendor.businessAddress || "N/A"}</p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-500">Document Type</p>
                            <p className="font-semibold text-gray-800">{vendor.kycDocumentType || "N/A"}</p>
                          </div>
                          <div>
                            <p className="text-xs text-gray-500">Business Document ({vendor.kycDocumentType || "N/A"})</p>
                            {vendor.kycDocumentUrl ? (
                              <a 
                                href={vendor.kycDocumentUrl} 
                                target="_blank" 
                                rel="noreferrer"
                                className="inline-flex items-center gap-1.5 mt-1 px-3 py-1.5 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition-colors text-sm font-semibold"
                              >
                                <FiFileText />
                                View Business Doc
                              </a>
                          ...
                          <div>
                            ...
                            {vendor.governmentIdDocumentUrl ? (
                              <a 
                                ...
                                target="_blank" 
                                rel="noreferrer"
                                className="inline-flex items-center gap-1.5 mt-1 px-3 py-1.5 bg-purple-100 text-purple-700 rounded-lg hover:bg-purple-200 transition-colors text-sm font-semibold"
                              >
                                <FiFileText />
                                View Gov ID
                              </a>
                            ) : (
                              <p className="text-sm text-gray-400 mt-1">No ID uploaded</p>
                            )}
                          </div>
                        </div>
                      </div>
