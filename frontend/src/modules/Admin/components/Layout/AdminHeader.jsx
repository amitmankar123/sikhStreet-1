...
const AdminHeader = ({ onMenuClick, sidebarWidth, isDesktop, isDragging }) => {
  ...
  return (
    <header
      className={`bg-white border-b border-gray-200 fixed top-0 left-0 right-0 z-30 ${isDragging ? '' : 'transition-all duration-300'}`}
      style={{
