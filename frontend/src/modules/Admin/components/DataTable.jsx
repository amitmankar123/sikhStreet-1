...
const DataTable = ({
  ...
  return (
    <div className={`bg-white rounded-xl shadow-sm overflow-hidden w-full max-w-full min-w-0 ${className}`}>
      ...
      <div className="hidden md:block overflow-x-auto scrollbar-admin w-full">
