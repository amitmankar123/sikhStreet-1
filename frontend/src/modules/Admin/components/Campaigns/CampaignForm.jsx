  ...
  const generatedSlug = useMemo(() => {
    if (formData.name) {
      ...
      const existingCampaigns = isEdit
        ? campaignsArr.filter((c) => (c.id || c._id) !== (campaign.id || campaign._id))
        : campaignsArr;
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div>
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-2 bg-blue-50 p-2.5 rounded-lg border border-blue-100 text-blue-700 font-medium">
                    Note: Admin does not assign products to this campaign directly. Vendors will add their own products to this campaign matching the selected category.
                  </p>
                </div>
              </div>
