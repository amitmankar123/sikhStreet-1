  ...
  const menuItems = [
    {
      ...
      icon: FiPackage,
      gradient: "from-vendor-primary via-[#0F2647] to-vendor-primary",
      lightGradient: "from-vendor-primary/5 via-vendor-primary/10 to-vendor-primary/5",
      shadowColor: "shadow-vendor-primary/20",
      hoverShadow: "hover:shadow-vendor-primary/30",
    ...
    },
    {
      ...
      label: "Add Product",
      icon: FiPlus,
      gradient: "from-vendor-accent via-vendor-accentHover to-[#A18223]",
      lightGradient: "from-vendor-accent/5 via-vendor-accent/10 to-vendor-accent/5",
      shadowColor: "shadow-vendor-accent/20",
      hoverShadow: "hover:shadow-vendor-accent/30",
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 text-center space-y-0.5 sm:space-y-1">
                  <h3 className="text-xs sm:text-base font-bold text-vendor-primary group-hover:text-vendor-accentHover transition-colors duration-300 leading-tight">
                    {item.label}
                  </h3>
