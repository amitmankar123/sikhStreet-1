  ...
  const cartBarContent = (
    <motion.div
      ...
      <motion.button
        data-cart-bar
        onClick={toggleCart}
        className="w-14 h-14 rounded-full bg-[#D4AF37] shadow-2xl flex items-center justify-center hover:shadow-3xl active:scale-[0.95] transition-all duration-300 group relative"
        animate={
          pulseAnimation
            ? {
              scale: [1, 1.1, 1],
