                        ...
                        <div className="px-2 md:px-4 py-2 md:py-4">
                            <div className="flex items-center gap-2 md:gap-3 mb-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <h1 className="text-2xl font-black text-slate-800 uppercase tracking-tight truncate">
                                        {brand.name}
                                    </h1>
                                    <div className="relative mt-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-9 pr-9 py-2.5 bg-white border-2 border-gray-300 rounded-2xl text-sm font-semibold focus:outline-none focus:border-brand-navy focus:ring-1 focus:ring-brand-navy transition-all placeholder:text-gray-400 shadow-sm"
                                        />
                                        {searchQuery && (
                                            <button
                                                onClick={() => setSearchQuery("")}
                                                className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 p-1 hover:bg-gray-200 rounded-full transition-colors"
                                            >
                                                <FiX className="text-sm" />
                                            </button>
                                        )}
                                    </div>
                                    <p className="text-xs font-extrabold text-[#FF7A1A] mt-1.5 bg-[#FF7A1A]/10 px-2.5 py-1 rounded-md inline-block shadow-sm">
                                ...
                                <div className="flex flex-row items-center gap-3 flex-shrink-0">
                                    ...
                                    <div ref={filterButtonRef} className="relative">
                                        <button
                                            ...
                                            <FiFilter
                                                className={`text-xl transition-colors ${hasActiveFilters ? "text-blue-600" : "text-gray-600"
                                                    }`}
                                            />
                                        </button>
