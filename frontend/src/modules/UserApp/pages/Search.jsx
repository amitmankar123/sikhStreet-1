...
import { FiSearch, FiFilter, FiX, FiMic, FiGrid, FiList, FiShoppingBag, FiTrendingUp, FiClock } from 'react-icons/fi';
              ...
              <div className="flex items-center gap-3">
                ...
                <div ref={filterButtonRef} className="relative">
                  <button
                    ...
                    className={`flex items-center gap-2.5 px-4 py-2 glass-card rounded-xl hover:bg-gray-100 transition-colors h-11 shadow-sm border border-slate-200 ${showFilters ? "bg-gray-100" : ""
                      }`}
                  >
                    <FiFilter
                    ...
                    />
                    <span className="font-extrabold text-slate-800 text-sm">Filters</span>
                  </button>
