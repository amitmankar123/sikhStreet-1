                ...
                <div className="w-full pb-24 lg:pb-12 max-w-7xl mx-auto min-h-screen bg-gray-50">
                    ...
                    <div className="bg-white border-b border-gray-200 sticky top-0 z-30">
                        <div className="px-2 md:px-4 py-2 md:py-4">
                            ...
                            {/* Vendor Profile Card */}
                            <div className="bg-white rounded-xl overflow-hidden shadow-sm flex flex-col items-center text-center pb-4 mb-4 relative">
                                {vendor.storeBanner ? (
                                    ...
                                    <div className="w-full h-24 md:h-32 bg-gradient-to-r from-primary-400 to-primary-600"></div>
                                )}
                                
                                <div className="w-24 h-24 rounded-full bg-white p-1 shadow-md overflow-hidden z-10 -mt-12 mb-3">
                                    <LazyImage
