...
router.post('/auth/check-availability', authLimiter, validate(checkAvailabilitySchema), authController.checkAvailability);
...
router.patch('/auth/complete-onboarding', ...vendorAuth, authController.completeOnboarding);
...
// Q&A
router.post('/questions/:questionId/answer', ...vendorAuth, qnaController.answerQuestion);
...
router.get('/campaigns/:id/products', ...vendorAuth, campaignController.getVendorCampaignProducts);
router.post('/campaigns/:id/products', ...vendorAuth, campaignController.updateVendorCampaignProducts);
