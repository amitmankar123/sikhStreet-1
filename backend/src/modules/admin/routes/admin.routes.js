...
router.delete('/customers/:id', ...adminAuth, validate(customerIdParamSchema, 'params'), customerController.deleteCustomer);
...
router.get('/delivery-boys', ...adminAuth, (req, res) => {
    res.status(200).json({
        success: true,
        statusCode: 200,
        data: {
        ...
        message: 'Delivery boys list (Mocked).'
    });
});
