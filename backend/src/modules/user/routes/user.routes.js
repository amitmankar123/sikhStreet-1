...
// Order routes
router.post('/orders/validate-stock', ...customerAuth, orderController.validateStock);
...
router.patch('/chat/threads/:id/read', ...customerAuth, chatController.markUserChatRead);

// Q&A routes (protected)
router.post('/questions', ...customerAuth, qnaController.askQuestion);
router.post('/questions/:questionId/answer', ...customerAuth, qnaController.answerQuestion);
